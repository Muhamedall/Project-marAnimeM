...
export interface ApiMyprojectMyproject extends Schema.CollectionType {
  collectionName: 'myprojects';
  info: {
    singularName: 'myproject';
...
export interface ApiStagaireStagaire extends Schema.CollectionType {
  ...
  info: {
    singularName: 'stagaire';
    pluralName: 'stagaires';
    displayName: 'Stagaire';
    description: '';
  };
  options: {
    draftAndPublish: true;
